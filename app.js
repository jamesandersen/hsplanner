...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module("hsp.auth").factory("hsAuthService", __webpack_require__(38));
	angular.module("hsp.auth").controller("HeaderCtrl", __webpack_require__(39));
	angular.module("hsp.auth").controller("LoginCtrl", __webpack_require__(40));
	angular.module("hsp.auth").controller("ProfileCtrl", __webpack_require__(41));
	angular.module("hsp.auth").factory("Profile", __webpack_require__(42));
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(12)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gcs = _interopRequireWildcard(__webpack_require__(33));
	
	angular.module("hsp.schedule", ["hsp.auth"]);
	
	angular.module("hsp.schedule").controller("EventDetailCtrl", __webpack_require__(34));
	...
	angular.module("hsp.schedule").filter("hasEvents", __webpack_require__(35));
	angular.module("hsp.schedule").controller("ScheduleCtrl", __webpack_require__(36));
	angular.module("hsp.schedule").factory("ScheduleModel", __webpack_require__(37));
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(12)))
